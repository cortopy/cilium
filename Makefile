...
define generate_k8s_api_deepcopy_client
	$(call generate_k8s_api,deepcopy$(comma)client,github.com/cilium/cilium/pkg/k8s/types/slim/client,$(1),$(2))
endef
...
define generate_k8s_protobuf
	PATH="$(PWD)/tools:$(PATH)" ./tools/go-to-protobuf \
		...
		--drop-embedded-fields="github.com/cilium/cilium/pkg/k8s/types/slim/k8s/meta/v1.TypeMeta" \
		--proto-import="$(PWD)" \
...
generate-k8s-api:
	$(call generate_k8s_protobuf,github.com/cilium/cilium/pkg/k8s/types/slim/k8s/core/v1$(comma)github.com/cilium/cilium/pkg/k8s/types/slim/k8s/meta/v1)
	$(call generate_k8s_api_deepcopy_client,github.com/cilium/cilium/pkg/k8s/types/slim/k8s,"\
	core:v1\
	")
	$(call generate_k8s_api_deepcopy,github.com/cilium/cilium/pkg/k8s/types/slim/k8s,"\
	meta:v1\
	")
